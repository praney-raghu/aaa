            ...
            <div id="regForm" class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div id="addressDetails" class="form-group{{ $errors->has('address') ? ' has-error' : '' }}" >
                        ...
                        <div id="districtDetails" class="form-group{{ $errors->has('district') ? ' has-error' : '' }}" >
                        ...
                        <div id="pincodeDetails" class="form-group{{ $errors->has('pincode') ? ' has-error' : '' }}" >
